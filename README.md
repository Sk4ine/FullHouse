# FullHouse
Наш проект - система ориентированная на работу с вузами. Она представляет собой приложение, которое награждает студентов за успехи в учебе и выполнение заданий преподавателей, а также предоставляет информацию о мероприятиях в вузе. Каждую контрольную точку студенты будут получать заслуженное количество бонусов за успеваемость и выполненные задания.
...
1. Удобство использования - удобство в использовании сервиса пользователем. Удобный, приятный, интуитивно понятный интерфейс. Удобная система уведомлений.
...
#### Начисление бонусов за успеваемость
![alt text](resources/images/sequence_diagram/Bonuses.jpg)

#### Покупка товара во внутреннем магазине
![alt text](resources/images/sequence_diagram/ProductBuy.jpg)
